#!/home/wei/miniconda3/envs/omni/bin/python
import argparse
...
class OmnidataModel:
    ...
    def __call__(self, im_tensor, im_fname=None, down_factor=1, target_size=None):
        # im_raw = read_image(str(im_fname))
        # if target_size is not None:
        #     im_raw = cv2.resize(im_raw, target_size)
...
if __name__ == "__main__":
    ...
    target_size = None
    # target_size = (536, 400)    # scannet / semantic-replica / 7-scenes
    target_size = (616, 344)    # replica / t&t
